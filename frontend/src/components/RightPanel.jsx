        ...
        <div className="flex-shrink-0 flex items-center justify-between p-8 border-b border-white/5">
          <div>
            <div className="flex items-center gap-2 mb-1">
              <span
                className={`h-1.5 w-1.5 rounded-full animate-pulse ${activeTab === "chat" ? "bg-indigo-500" : "bg-rose-500"}`}
              ></span>
              <span
                className={`text-[10px] font-black tracking-[0.3em] uppercase ${activeTab === "chat" ? "text-indigo-500" : "text-rose-500"}`}
              >
